...
public static class DbInitializer
{
    public static void SeedDatabase(CheepDBContext chirpContext)
    {
        if (!(chirpContext.Authors.Any() && chirpContext.Cheeps.Any()))
        {
            ...
            var c601 = new Cheep() { CheepId = 601, AuthorId = a11.AuthorId, Author = a11, Text = "Hello, BDSA students!", TimeStamp = DateTime.Parse("2024-11-22 12:16:48") };
            var c602 = new Cheep() { CheepId = 602, AuthorId = a12.AuthorId, Author = a12, Text = "Hej, velkommen til kurset.", TimeStamp = DateTime.Parse("2024-11-22 13:08:28") };
